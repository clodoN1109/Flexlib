...
$item1Origin       = "$dataPath/input/Item1.pdf"
$item2Origin       = "$dataPath/input/Item2.pdf"
$item3Origin       = "$dataPath/input/Item3.pdf"
...
& $flexlibPath new-item TestLibrary Item1 $item1Origin  
& $flexlibPath new-item TestLibrary Item2 $item2Origin 
& $flexlibPath new-item TestLibrary Item3 $item3Origin 
