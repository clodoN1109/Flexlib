...
public static class GetItemOrigin
{
    public static Result Execute(object itemId, string libName, ILibraryRepository repo)
    {
        ...
        return validation.IsSuccess
            ? _GetItemOrigin(parsedArgs)
            : validation;
    }

    private static Result _GetItemOrigin(ParsedArgs parsedArgs)
    {
        ...
        return Result.Success($"Item origin successfully obtained. \n\n '{selectedItem!.Origin}'", selectedItem!.Origin);
